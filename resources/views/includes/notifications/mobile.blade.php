<div class="single-item messages-area notification-area">
    ...
    <div class="main-area p-5 notification-content">
            ...
            <a href="{{ $notification->data['url'] }}" class="d-flex justify-content-between align-items-center">
                ...
                <div class="left-item position-relative d-inline-flex gap-3">
                    <div class="avatar position-relative d-inline-flex">
                        <img class="avatar-img max-un" src="{{ $notification->data['avatar'] }}" alt="avatar" width="48" height="48">

                        @if ($notification->type == 'App\Notifications\UserCommented')
                        <img class="abs-item position-absolute max-un" src="/images/speech-bubble.png" alt="icon" width="20" height="20">
                        @elseif ($notification->type == 'App\Notifications\UserLiked')
                        <img class="abs-item position-absolute max-un" src="/images/emoji-love.png" alt="icon" width="20" height="20">
                        @elseif ($notification->type == 'App\Notifications\UserRequested')
                        <img class="abs-item position-absolute max-un" src="/images/plus-icon.png" alt="icon" width="20" height="20">
        ...
        @endforeach
        <div class="btn-area">
            <a href="profile-notification.html">See all notifications</a>
        </div>
        @endif
    </div>
</div>