                                        ...
                                        <div class="info-item active">
                                            <div class="top-area px-4 py-3 d-flex gap-3 align-items-start justify-content-between">
                                                <div class="title-area">
                                                    <h6 class="m-0 mb-3">
                                                        <a href="public-profile-post.html">{{ $comment->user->first_name }}</a>
                                                    </h6>
                                            ...
                                            <form action="#" class="comment-form">
                                                <div class="d-flex gap-3">
                                                    <input type="text" class="newsfeed-reply-input" placeholder="Write a comment.." class="py-3" data-comment_id="{{ $comment->id }}">
